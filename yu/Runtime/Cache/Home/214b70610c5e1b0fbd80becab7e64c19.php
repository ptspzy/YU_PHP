...
<div class="container-fluid">
    ...
    <ul class="nav nav-sidebar">
        <li>
            <a href="<?php echo U('Urls/index');?>">
            	<span class="glyphicon glyphicon-plus" aria-hidden="true"> 添加
        	</a>
        </li>
        <li>
    ...
    <ul class="nav nav-sidebar">
    	<li>
            <a id="show-note" href="<?php echo U('Urls/show');?>">
                <span class="glyphicon glyphicon-globe" aria-hidden="true"> URLS
             </a>
        </li>
        <li>
            <a id="show-note" href="<?php echo U('Notes/show');?>">
                <span class="glyphicon glyphicon-fire" aria-hidden="true"> 轻笔记
             </a>
        </li>
        <li>
        	<a id="show-all-tags" href="<?php echo U('Index/tags');?>">
        		<span class="glyphicon glyphicon-tags" aria-hidden="true"> 所有标签
        	</a>
        </li>
    </ul>
</div>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div id="urls-show" class="list-group">
                <?php if(is_array($list_notes)): foreach($list_notes as $key=>$data): ?><blockquote>
                        <p><?php echo ($data['note_content']); ?></p>
                        <small><?php echo ($data['note_tag']); ?><cite title="Source Title"> <?php echo ($data['note_time']); ?></cite></small>
                    </blockquote><?php endforeach; endif; ?>
                <?php if($page): ?><div  class="pages">
    <ul  class="pagination pagination-right pagination-sm">
